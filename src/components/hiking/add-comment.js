...
const AddHikeComment = (props) => {
  ...
  const handlePhotoChange = (event) => {
    setComment({
      ...comments,
      comments: { ...props.comments, photo: event.target.value},
    });
  };
  ...
  //   setComment({
  //     ...comments,
  //     comments: { ...props.comments, name: event.target.value},
  //   });
  // };
  ...
  //   setComment({
  //     ...comments,
  //     comments: { ...props.comments, weather: event.target.value},
  //   });
  // };
  ...
  //   setComment({
  //     ...comments,
  //     comments: { ...props.comments, commentSection: event.target.value},
  //   });
  // };
        ...
        <div className="modal">
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleCommentSubmit}>
              ...
              <input type="text" name="name" placeholder="Your name goes here" onChange={handleAddCommentChange} />

              <label htmlFor="duration">Duration</label>
              <input type="" name="duration" placeholder="How long was your hike in minutes?" onChange={handleAddCommentChange} />
              ...
              <textarea rows="4" cols="50" name="commentSection" placeholder="What was the hike like? What should other hikers know about the trail?" onChange={handleAddCommentChange}>
                </textarea>
